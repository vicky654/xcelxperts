            ...
            <div className="panel mt-6">
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        records={recordsData}
                        columns={[
                            { accessor: 'id', title: 'ID',    sortable: false, hidden: hideCols.includes('id') },
                            {
                                accessor: 'firstName',
                                title: 'First Name',
                                   sortable: false,
                            ...
                            { accessor: 'email', title: 'Email',    sortable: false, hidden: hideCols.includes('email') },
                            { accessor: 'phone', title: 'Phone',    sortable: false, hidden: hideCols.includes('phone') },
                            {
                                accessor: 'company',
                                title: 'Company',
                                   sortable: false,
