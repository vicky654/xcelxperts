...
import PieChart from '../DsrModules/PieChart';
import StatsBarChart from '../DsrModules/StatsBarChart';
import DashboardFilter from '../DsrModules/DashboardFilter';
...
const NewDashboardSubChild: React.FC<ManageSiteProps> = ({ postData, getData, isLoading }) => {
...
export default withApiHandler(NewDashboardSubChild);
