                            ...
                            <div key={sectionName} className="mb-4">
                                ...
                                <div className="pl-4">
                                    {permissions[sectionName].names.map((perm) => (
                                        <div key={perm.name} className="form-check form-check-inline mb-2">
                                            <input
                                    ...
                                    {formik.touched.selectedPermissions && formik.errors.selectedPermissions && <p className="mt-2 text-sm text-red-600">{formik.errors.selectedPermissions}</p>}
                                </div>
                            </div>
                        ))}
