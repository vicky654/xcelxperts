                    ...
                    <div className="relative w-screen max-w-md">
                        <div className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                            <div className="flex-1 w-full">
                                <AddModalHeader title={isEditMode ? 'Edit Extra Income' : 'Add Extra Income'} onClose={onClose} />
                                    ...
                                    <form onSubmit={formik.handleSubmit} className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 mb-5 bg-white dark:bg-black">
                                        <div className="flex flex-col sm:flex-row">
                                            <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                                <FormikInput formik={formik} type="text" name="charge_code" label='Extra Income Code' placeholder='Extra Income Code' readOnly={isEditMode ? true : false} />
                                                <FormikInput formik={formik} type="text" name="charge_name" label='Extra Income Name' placeholder='Extra Income Name' />
