...
interface AddEditStationFuelSellingModalProps {
    isOpen: boolean;
    onClose: () => void;
...
const AddEditStationFuelSellingModal: React.FC<AddEditStationFuelSellingModalProps> = ({ isOpen, onClose, getData, onSubmit, isEditMode, userId }) => {
...
export default AddEditStationFuelSellingModal;